...
export default function WhatsAppCard({ phoneNumber, businessName }) {
  ...
  return (
    <div className="bg-[var(--cresoa-surface)] border border-[var(--cresoa-border)] rounded-xl p-5 shadow-sm mt-6">
      <div className="flex items-start gap-4">
        <div className="w-10 h-10 rounded-full bg-[#25D366]/10 flex items-center justify-center flex-shrink-0">
          <Icon name="message-circle" className="w-5 h-5 text-[#25D366]" />
        </div>
        <div className="flex-1">
          <h3 className="font-medium text-[var(--cresoa-text)] text-sm mb-1">Need human help?</h3>
