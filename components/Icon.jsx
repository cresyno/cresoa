...
export const Icon = ({ name, size = 20, stroke = 'currentColor', strokeWidth = 2, className, style, ...props }) => {
  const getIcon = () => {
    switch (name) {
      ...
      case 'credit-card': return (<><rect x="1" y="4" width="22" height="16" rx="2" ry="2" /><line x1="1" y1="10" x2="23" y2="10" /></>);
      ...
      case 'edit-2': return (<><path d="M17 3a2.83 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" /></>);
      case 'trash-2': return (<><polyline points="3 6 5 6 21 6" /><path d="M19 6l-1.6 14a2 2 0 0 1-2 1.8H8.6a2 2 0 0 1-2-1.8L5 6" /><path d="M10 11v6" /><path d="M14 11v6" /><path d="M9 3h6a1 1 0 0 1 1 1v2H8V4a1 1 0 0 1 1-1z" /></>);
      case 'copy': return (<><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></>);
      case 'refresh-cw': return (<><polyline points="23 4 23 10 17 10" /><polyline points="1 20 1 14 7 14" /><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" /></>);
      ...
      case 'tool': return (<><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /></>);
      ...
      case 'tag': return (<><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" /><line x1="7" y1="7" x2="7.01" y2="7" /></>);
      ...
      case 'printer': return (<><polyline points="6 9 6 2 18 2 18 9" /><path d="M18 9H6a4 4 0 0 0-4 4v4h4v-4h12v4h4v-4a4 4 0 0 0-4-4z" /><rect x="6" y="17" width="12" height="5" rx="2" /></>);
  ...
  return (<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className} style={style} {...props}>{getIcon()}</svg>);
};
