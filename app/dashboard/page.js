...
export default function DashboardPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#F5EFE2', padding: '2rem 1.5rem' }}>
      ...
      <h2 style={{ color: '#1E3A5F', fontSize: '1.1rem', marginBottom: '0.8rem' }}>Customers</h2>
      {customers.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
          {customers.map((c) => (
            <div key={c.id} style={{ background: '#fff', borderRadius: '10px', padding: '1rem', border: '1px solid #e4d8c2' }}>
