      ...
      return (
        <main className="order-page">
          <div className="error-card">
            ...
            <p>We could not load this order. Please try again.</p>
            <button
              type="button"
              onClick={loadOrder}
            ...
            >
              ...
              <div className="status-options">
                {STATUS_FLOW.map((status, index) => {
                  ...
                  const current =
                    (order?.current_status || 'Order placed') ===
                    status.value
                  const passed =
                    index < statusIndex
    ...
    return (
      <main className="order-page">
        <div className="error-card">
          ...
          <p>{renderError || 'An unexpected error occurred while rendering this order.'}</p>
