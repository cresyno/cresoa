    ...
    <div className={styles.page}>
      ...
      {selectedIds.length > 0 && (
        <div className={styles.bulkBar}>
          ...
          <button onClick={() => applyBulkActive(true)} disabled={saving} className={styles.smallButton}>Set available</button>
          <button onClick={() => applyBulkActive(false)} disabled={saving} className={styles.smallButton}>Pause</button>
      ...
      <div className={styles.layout}>
                    ...
                    <div className={styles.cardBody}>
                      ...
                      <div className={styles.cardActions}>
                        ...
                        <button onClick={() => toggleActive(product)} className={styles.smallButton}>
                          {product.active ? 'Pause' : 'Make available'}
                        </button>
                      ...
                      {product.on_website && !product.active && (
                        <p className={styles.hint}>Won't show on your shop while paused.</p>
                      )}
                    </div>
                  </div>
                </div>
        ...
        <div className={`${styles.column} ${mobileView !== 'website' ? styles.columnHiddenMobile : ''}`}>
          ...
          <p className={styles.hint}>Paused items stay in this list but won't show on your live shop.</p>
              ...
              {websiteProducts.map((product) => (
                <div key={product.id} className={styles.card}>
                  <div className={styles.cardTop}>
                    ...
                    <div className={styles.cardBody}>
                      <div className={styles.badgeRow}>
                        {!product.active && <span className={`${styles.badge} ${styles.badgeInactive}`}>Paused — not visible</span>}
        ...
        <div className={styles.modalOverlay} onClick={() => setShowEditModal(false)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.toggleGroup}>
              <label className={styles.checkboxLabel}>
                <input type="checkbox" name="active" checked={form.active} onChange={handleFormChange} /> Available
              </label>
              <label className={styles.checkboxLabel}>
